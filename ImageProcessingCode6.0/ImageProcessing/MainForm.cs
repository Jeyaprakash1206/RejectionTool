...
namespace ImageProcessing
{
    class WriteLogFile
    {
        public static bool WriteLog(string strFileName, string strMessage)
        {
            try
            {
                FileStream objFilestream = new FileStream(string.Format("{0}\\{1}", @"C:/ImageProcessing", strFileName), FileMode.Append, FileAccess.Write);
       ...
       // public bool Makeselection = false;
        ...
        public void LoadConfig()
        {
            try
            {
                ...
                string textFile = @"C:/ImageProcessing/config.txt";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string SROCODE = SROCODETXT.Text;
            ...
            {
                string filename = DocType + "_" + SROCODE + "_" + BookNumber + "_" + DocNo + "_" + Year + ".tif";
        ...
        private void Cropbtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    Rectangle rect = new Rectangle(0, 0, OriginalImage.Width, (OriginalImage.Height - (OriginalImage.Height - cropY)));
                    //Original image
                    Bitmap _img = new Bitmap(OriginalImage.Width, (OriginalImage.Height - (OriginalImage.Height - cropY)));
                    // for cropinf image
        ...
        private void FillRoundedRectangle(Graphics G, int X1, int Y1, int X2, int Y2)
        {
            ...
            G.FillRectangle(Brushes.White, X1 + 1, Y1, width - 2, height);
